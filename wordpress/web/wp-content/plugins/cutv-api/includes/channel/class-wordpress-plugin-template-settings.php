...
class CUTV_Channel_Settings {

	/**
	 * The single instance of CUTV_Channel_Settings.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	/**
	 * Main CUTV_Channel_Settings Instance
	 *
	 * Ensures only one instance of CUTV_Channel_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see CUTV_Channel()
	 * @return Main CUTV_Channel_Settings instance
	 */
